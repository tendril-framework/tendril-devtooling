...
setup(
    name='tendril-devtooling',
    use_scm_version={"root": ".", "relative_to": __file__},
    author="Chintalagiri Shashank",
    author_email="shashank@chintal.in",
    description="Generic Development Tooling from Tendril",
    long_description='\n'.join([read('README.rst'), read('CHANGELOG.rst')]),
    long_description_content_type='text/x-rst',
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-devtooling',
    project_urls={
        'Documentation': 'https://tendril-devtooling.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-devtooling/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-devtooling',
    },
